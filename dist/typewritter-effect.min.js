 ...
 * typewritter-effect
 * v0.0.2
 * built: Sun, 26 Jun 2016 16:48:33 GMT
...
function(){this.typingTimer&&clearTimeout(this.typingTimer);this.currLetter=-1;this.currSentence=0;this.typingTimer=null;return this};return{start:function(a){return(new e({containerId:a.containerId,extractClass:a.extractClass,cursorClass:a.cursorClass})).stop().writeNext()}}});